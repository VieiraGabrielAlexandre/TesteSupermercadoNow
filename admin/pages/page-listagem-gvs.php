...
<div class="content" style="padding:0px 11px 11px 1px;">

	<div class="col-xs-10" style="margin-top:-10px;">
		<?php if($diretorias){ $i = 0; $abriu = false; ?>
			<?php foreach($diretorias as $diretoria => $dados){ $i++; ?>

			<?php if($i===1){$abriu=true; ?>
			<div class="col-xs-1" style="min-width:111px;">
			<?php } ?>

				<a href="<?php echo $config['baseurl_admin'].'/gvs/listagem/'.$diretoria;?>" class="btn btn-default btn-block btn-float btn-float-lg" style="margin-top:10px;">
					<span style="padding:0px 0px 3px 0px;"><?php echo $diretoria;?></span>
				</a>

			<?php if($i===2){$i=0;$abriu=false; ?>
			</div>
			<?php } ?>
	...
	<div class="col-xs-1" style="min-width:78px;">
		<a href="#" class="btn btn-default btn-block btn-float btn-float-lg" style="cursor:default;">
			<i class="icon-users text-blue"></i>
			<span><?php echo $total_dados;?> GVS</span>
		</a>
	</div>
	<div class="col-xs-1" style="min-width:78px;">
		<a href="<?php echo $url_exportar;?>" class="btn btn-default btn-block btn-float btn-float-lg">
...
<div class="content">
	...
	<?php if(isset($exportar) && $exportar){?>
