			...
			<form class="form-group" method="get" style="margin:0;">
				<div class="col-lg-10">
					<div class="input-group">
						<input type="text" class="form-control" placeholder="Busca" name="b" value="<?php echo (isset($_GET['b']) && $_GET['b'] ? $_GET['b'] : '');?>">
				...
				<div class="col-lg-2">
					<span class="input-group-btn">
						<a class="btn bg-success" href="<?php echo $exportar;?>" style="display:block;width:50%;float:right;clear:both;">Exportar</a>
					</span>
				</div>
				<?php } ?>
			</form method="get">
