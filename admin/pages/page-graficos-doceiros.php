...
<div class="content">
	...
	<div class="row">
								...
								<td class="col-md-5">
									...
									<div class="media-left">
										...
										<ul class="list-inline list-inline-condensed no-margin">
											<li>
												<span class="text-muted">Total de doceiros</span>
											</li>
										</ul>
									</div>
								</td>
								...
								<td class="col-md-5">
									...
									<div class="media-left">
										...
										<ul class="list-inline list-inline-condensed no-margin">
											...
											<li>
												<span class="text-muted">Total de doceiros ativos</span>
											</li>
										</ul>
									</div>
								</td>
		...
		<div class="col-md-6">
			...
			<?php $chave_grafico++; $var_grafico = $grafico['grafico-gerentes-ativacao-data']; ?>
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title"><?php echo $var_grafico['titulo']?></h5>
					<div class="heading-elements">
